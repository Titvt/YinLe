...
public class HomeRecyclerViewAdapter extends PagedListAdapter<AlbumInfo, HomeRecyclerViewAdapter.HomeRecyclerViewHolder> {
    ...
    HomeRecyclerViewAdapter(@NonNull DiffUtil.ItemCallback<AlbumInfo> diffCallback, Context context, LayoutInflater layoutInflater, MainViewModel mainViewModel) {
        super(diffCallback);
    ...
    public HomeRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HomeRecyclerViewHolder(DataBindingUtil.inflate(layoutInflater, R.layout.home_recycler_view_item, parent, false));
    }
