...
import com.titvt.yinle.adapter.LibraryRecyclerViewAdapter;
...
public class LibraryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FragmentLibraryBinding fragmentLibraryBinding = DataBindingUtil
        ...
        LibraryRecyclerViewAdapter libraryRecyclerViewAdapter =
                new LibraryRecyclerViewAdapter(new DiffUtil.ItemCallback<AlbumInfo>() {
                    @Override
        ...
        fragmentLibraryBinding.setSongInfo(new SongInfo(0, "音乐（lè），享受白嫖的快感",
        ...
        mainViewModel.getCurrentPlaying().observe(getActivity(), songDetail ->
                fragmentLibraryBinding.setSongInfo(songDetail.getSongInfo()));
        mainViewModel.getIsPlaying().observe(getActivity(), isPlaying ->
                fragmentLibraryBinding.play.setImageResource(!isPlaying ? R.mipmap.play_blue : R.mipmap.pause));
